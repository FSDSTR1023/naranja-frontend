...
<div className='flex flex-col md:w-full h-full w-full'>
   {/* task navbar */}
   <div className='flex flex-col flex-wrap md:flex-row md:justify-between md:items-center md:w-full bg-gray-800 box-border p-1 sm:flex-col'>
      ...
      <div className='md:ml-3 gap-3 flex flex-row items-center flex-wrap justify-center'>
         ...
         <div className='space-x-1 flex align-center'>
            ...
            className="flex-none bg-orange-400 p-2 text-center text-white text-[9px] font-bold rounded-md hover:bg-orange-400 pointer-events-auto"
            >
            {"<"}
            </button>
            <input
         ...
         <div>
            <button
               className="bg-orange-500 p-2.5 px-6 border border-orange-500 text-center text-white text-[9px] font-bold rounded-md hover:bg-orange-400 hover:border-orange-400 m-2 whitespace-nowrap"
   ...
   <div className='flex flex-row h-full w-full overflow-auto mb-5 bg-gray-100'>
      ...
      <div
      className={clsx(
      'transition h-fit sm:w-full bg-gray-100 border border-gray-300 rounded-[7px]',
      !isOpen ? 'hidden' : 'block'
      )}>
      <ChatComponent />
   </div>
