    ...
    <div className='w-screenorange h-screen bg-gray-50'>
      <div className="text-center">
        ...
        <h2 className='text-xl text-gray-900 max-w-6xl mx-auto'>
          ...
          <span className="text-orange-400">chatear</span>, hacer <span className="font-bold text-orange-400"> videollamadas </span><br /> y tener un 
          <span className="text-orange-400"> dashboard de tareas </span>
